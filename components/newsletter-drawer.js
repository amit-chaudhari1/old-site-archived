...
const NewsletterDrawer = ({ mobile, placement }) => {
	...
	const onSubmit = async (data, e) => {
		const response = await fetch("https://app.convertkit.com/", {
			method: "post",
			body: JSON.stringify(
					...
					<DrawerContent borderTopRadius="6px">
						...
						<DrawerBody pb={4}>
							<VStack align="stretch" spacing={4}>
								<Text>
									Want to stay in loop on new articles and
									projects? Then drop your email below.
								...
								>
									<VStack spacing={4}>
										...
										>
											...
											>
												<AlertIcon />
												Success! Now check your email to
